package ppf.tool.components.mx.components.controls
{
	...
	public class NumericStepper extends mx.controls.NumericStepper
	{
		...
		{
			return LocaleManager.getInstance().getString(LocaleConst.LIB,'LIB_TIP_056')
				+ object.minimum + " "+LocaleManager.getInstance().getString(LocaleConst.LIB,'LIB_TIP_030')+" " + object.maximum;
		}
