package ppf.tool.components.mx.components.controls
{
	...
	[IconFile("/assets/ScrollableArrowMenu.png")]
	...
	public class ScrollableArrowMenu extends ScrollableMenu
	{
		 ...
		 */
		private var upButton:mx.controls.Button;
		
		/**
		 * @private
		 * The buttons that are used for the scrolling up and down
		 */
		private var downButton:mx.controls.Button;
...
//			FLEX_TARGET_VERSION::flex4
//			{
				selector = FlexGlobals.topLevelApplication.styleManager.getStyleDeclaration("ScrollableArrowMenu");
//			}
//			FLEX_TARGET_VERSION::flex3
//			{	
//				selector = StyleManager.getStyleDeclaration("ScrollableArrowMenu");
//			}
...
//			FLEX_TARGET_VERSION::flex4
//			{
				upSelector = FlexGlobals.topLevelApplication.styleManager.getStyleDeclaration("." + upStyleName);
//			}
//			FLEX_TARGET_VERSION::flex3
//			{
//				upSelector = StyleManager.getStyleDeclaration("." + upStyleName);
//			}
...
//			FLEX_TARGET_VERSION::flex4
//			{
				downSelector = FlexGlobals.topLevelApplication.styleManager.getStyleDeclaration("." + downStyleName);
//			}
//			FLEX_TARGET_VERSION::flex3
//			{
//				downSelector = StyleManager.getStyleDeclaration("." + downStyleName);
//			}
...
//			}
		...
		override protected function createChildren():void {
			...
			upButton = new mx.controls.Button();
			
			downButton = new mx.controls.Button();
