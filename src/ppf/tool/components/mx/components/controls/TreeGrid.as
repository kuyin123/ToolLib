...
{
  import ppf.tool.components.TreeGridListData;
  ...
  public class TreeGrid extends DataGrid
  {
    ...
    {
	  if (!isBranch(event.itemRenderer.data))
		  return;
...
//      super.selectedItems = savedSelection;
	  ...
	  var iCollectView:ICollectionView = _dataDescriptor.getChildren(item);
	  if (null == iCollectView)
		  return -1;
	  return iCollectView.length + offset;
