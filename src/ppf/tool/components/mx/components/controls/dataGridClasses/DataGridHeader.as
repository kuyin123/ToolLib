package ppf.tool.components.mx.components.controls.dataGridClasses
{
	...
	import mx.controls.dataGridClasses.DataGridHeaderBase;
	...
	public class DataGridHeader extends DataGridHeaderBase
	{
		 ...
		 *  @productversion Flex 3
		 */
		public var needRightSeparator:Boolean = true;
		...
		override protected function updateDisplayList(w:Number, h:Number):void
		{
			...
			if (headerItemsChanged && (cols && cols.length > 0 || dataGrid.headerVisible))
			{
				...
				var data:Object;
				var uid:String;
				var c:mx.controls.dataGridClasses.DataGridColumn;
		...
		private function columnResizeMouseUpHandler(event:Event):void
		{
			...
			var c:mx.controls.dataGridClasses.DataGridColumn = resizingColumn;
			resizingColumn = null;
		...
		private function columnDraggingMouseMoveHandler(event:MouseEvent):void
		{
			...
			var item:IListItemRenderer;
			var c:mx.controls.dataGridClasses.DataGridColumn = dataGrid.movingColumn;
			var s:Sprite;
			var i:int = 0;
		 ...
		 */
		private function get resizingColumn():mx.controls.dataGridClasses.DataGridColumn
		{
		 ...
		 *  The column that is being resized.
		 */
		private function set resizingColumn(value:mx.controls.dataGridClasses.DataGridColumn):void
		{
